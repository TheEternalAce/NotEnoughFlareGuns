...
{
    public class PlasmaBeaconProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            var infernal = player.InfernalPlayer();
            if (progress < 0f)
            {
                Projectile.Kill();
                return;
            ...
            if (!player.frozen && !player.stoned)
            {
                ...
                if (Main.myPlayer == player.whoAmI)
                {
                    ...
                    //}
                    Projectile.velocity = FactoryHelper.RotateTowards(Projectile.Center, Projectile.velocity, Main.MouseWorld, 1);
                    Projectile.netUpdate = true;
                }
