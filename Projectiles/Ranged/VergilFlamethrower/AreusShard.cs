...
namespace NotEnoughFlareGuns.Projectiles.Ranged.VergilFlamethrower
{
    public class AreusShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (ModLoader.TryGetMod("ShardsOfAtheria", out Mod shards))
            {
                ...
                {
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, shards.Find<ModDust>("AreusDust").Type);
                }
            }
        }
    }
